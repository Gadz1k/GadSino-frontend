...
// --- ŁADOWANIE GRAFIK ---
PIXI.Loader.shared
    .add('background', 'slots/grid_background.png')
    .add('cash_infinity', 'slots/cash_infinity.png')
    .add('mystery', 'slots/mystery.png')
    .add('mini_jackpot', 'slots/mini_jackpot.png')
    .add('minor_jackpot', 'slots/minor_jackpot.png')
    .load(onAssetsLoaded);
